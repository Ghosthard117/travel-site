  ...
  return (
    <section className="flexCenter flex-col">
      ...
      <div className="flexCenter max-container relative w-full">
        ...
        />
        <div
          className="absolute flex bg-slate-50 py-8 pl-5 pr-7 gap-3 rounded-3xl border shadow-md md:left-[5%] lg:top-20"
        >
          <Image
            src="/meter.svg"
            alt="meter"
          ...
          <div className="flexBetween flex-col">
            <div className="flex w-full flex-col">
              <div className="flexBetween w-full">
                <p className="regular-16 text-slate-400">Destination</p>
                <p className="bold-16 text-green-50">48 min</p>
              </div>
              <p className="bold-20 mt-2">Aguas Calientes</p>
            </div>
            <div className="flex w-full flex-col">
              <p className="regular-16 text-slate-400">Start Track</p>
